                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php if (isset($nameError)) : ?>
                                <div class="text-warning"><?= h($nameError) ?></div>
                            <?php endif; ?>
                            <input type="text" class="form-control" id="inputname" autofocus name="name" value="<?= h($name) ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php if (isset($kanaError)) : ?>
                                <div class="text-warning"><?= h($kanaError) ?></div>
                            <?php endif; ?>
                            <input type="text" class="form-control" id="inputkana" name="kana" value="<?= h($kana) ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php if (isset($emailError)) : ?>
                                <div class="text-warning"><?= h($emailError) ?></div>
                            <?php endif; ?>
                            <input type="email" class="form-control" id="inputemail" name="email" value="<?= h($email) ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php if (isset($inquiryError)) : ?>
                                <div class="text-warning"><?= h($inquiryError) ?></div>
                            <?php endif; ?>
                            <textarea rows="10" cols="100" class="form-control" id="message" name="inquiry" required maxlength="999" style="resize:none"><?= h($inquiry) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
