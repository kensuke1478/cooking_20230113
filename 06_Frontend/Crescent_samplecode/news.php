            ...
            <?php foreach ($news as $item):?>
				<div class="well well-lg">
					<div class="media">
						<a class="pull-left">
                        <?php if ($item['image']):?>
                <img class="media-object" src="<?=h(IMAGE_PATH . $item['image'])?>" width="64" height="64" alt="">
            <?php else:?>
                <img class="media-object" src="images/press.png" width="64" height="64" alt="">
            <?php endif;?>
            </a>
						<div class="media-body">
							<h4 class="media-heading"><?=$item['title']?>
                <small><?=h((new DateTime($item['posted_at']))->format('F j, Y'))?></small>
                </h4><?=h($item['message'])?></div>
					</div>
				</div>
                <?php endforeach;?>
			</div>
